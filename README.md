...
Literature Review 
2.1 
Studies on class-based biases against english dialect speakers
Full article: Multicultural London English and its speakers: a corpus-informed discourse study of standard language ideology and social stereotypes “The non-MLE speakers were also found to hold much stronger, and very negative, social stereotypes of multiethnolect speakers. There was evidence of their use of iconisation and erasure in order to create linguistic (and social) differences between themselves and MLE speakers”
...
For every prompt, answer the following questions:
A person says this expression.
They work as:
They are:
They tend to have the following traits.
Do this for all prompts
...
What educational and professional qualifications do they have? 
...
Qualifications
Queen’s English
Results seem quite random, there is no obvious pattern in the jobs associated with QE speakers.
ChatGPT mentions houses and the suburbs when assuming accommodations for QE speakers.
The observations here are the same for QE and SE. ChatGPT assumes that the speaker has completed a high school diploma, and possibly beyond that. The qualifications highlighted are mostly communication-related. In the case of QE, management is cited 39 times. 
Singaporean English
Similarly to QE, the jobs stated for SE speakers do not follow a stereotypical pattern.
The assumptions are again similar to QE, but condominiums are more often cited.
Multicultural London English
MLE speakers are often associated with an urban setting, and the occupations suggested by ChatGPT follow this assumption. Hence, we see jobs like DJ, those in fashion, and other urban and young jobs.
ChatGPT mentions council and public housing multiple times. Otherwise, it is assumed that the speaker lives in shared housing. This is always in an urban setting. 
ChatGPT assumes MLE speakers have skills in fashion, music, and “street” or urban industries. They underline vocational skills more than academic skills and qualifications. 
Northern English
A recurring word associated with NE speakers, as seen in 4.1, is “blue-collar”. These assumptions are common, and ChatGPT very often assumes that those saying NE prompts work trade jobs or blue-collar jobs, notably in construction and manufacturing, or in hospitality. 
When making assumptions on housing, ChatGPT often cites shared housing or semi-detached houses. Additionally, the responses often include notes specifying that these accommodations are not flashy or luxurious.
For NE, ChatGPT underlines vocational skills and mentions apprenticeship 23 times. The responses often question whether the speaker has completed a diploma or pursued higher education. 

Table 3: Observations from the long prompt responses
...
List of words excluded from word clouds (in addition to stop words)
